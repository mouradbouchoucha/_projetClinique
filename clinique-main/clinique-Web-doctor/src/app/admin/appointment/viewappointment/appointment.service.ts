...
export class AppointmentService extends UnsubscribeOnDestroyAdapter {
  ...
  private readonly API_URL = "http://localhost:8081/appointment";
  isTblLoading = true;
  ...
  getAllAppointments(): void {
    this.subs.sink = this.httpClient.get<Appointment[]>(this.API_URL+"/all").subscribe(
      (data) => {
  ...
  addAppointment(appointment: Appointment): void {
    ...
    appointment.entrepriseId=environment.clinique
