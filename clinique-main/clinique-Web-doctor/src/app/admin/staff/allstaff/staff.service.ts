...
export class StaffService extends UnsubscribeOnDestroyAdapter {
  ...
  private readonly API_URL = "http://localhost:8081/technicien";
  isTblLoading = true;
  ...
  /** CRUD METHODS */
  getAllStaffs(): void {
    this.subs.sink = this.httpClient.get<Staff[]>(this.API_URL+"/all").subscribe(
      (data) => {
  ...
  addStaff(staff: Staff): void {
    this.dialogData = staff;
      staff.entrepriseID=environment.clinique;
