  ...
  implements OnInit
{
  ...
  public filters = [
    { name: "enCours", value: "En cours", checked: true },
    { name: "confirme", value: "Confirmé", checked: true },
    { name: "enAttente", value: "En attente", checked: true },
    { name: "cloture", value: "clôturé", checked: true },
    { name: "annule", value: "Annulé", checked: true },
  ];
  ...
  constructor(
    ...
    super();
    this.dialogTitle = "Ajouter rendez-vous";
  ...
  getClassNameValue(category) {
    ...
    if (category === "enCours") className = "fc-event-success";
    else if (category === "confirme") className = "fc-event-warning";
    else if (category === "enAttente") className = "fc-event-primary";
    else if (category === "cloture") className = "fc-event-danger";
    else if (category === "annule") className = "fc-event-info";
